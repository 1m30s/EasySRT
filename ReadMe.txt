========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : EasySRT
========================================================================


AppWizard が生成した EasySRT には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには EasySRT を構成している各ファイルの概要説明が含まれています。
...
EasySRT.h
    ...
    みます） をインクルードし、また CEasySRTApp アプリケーションクラスを宣
    言します。

EasySRT.cpp
    このファイルは CEasySRTApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\EasySRT.ico
    ...
    ルです。このアイコンはリソース ファイル EasySRT.rc によってインクルード
    されます。
...
EasySRTDlg.h, EasySRTDlg.cpp - ダイアログ
    これらのファイルは CEasySRTDlg クラスを含みます。このクラスは 
    アプリケーションのメイン ダイアログの動作を定義します。ダイアログ
    テンプレートは Microsoft Visual C++ で編集可能な EasySRT.rc に含
    まれます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) EasySRT.pch 
